                ...
                <image href="/partograma.png" x="0" y="0" width="100%" height="100%" preserveAspectRatio="none" />
                 ...
                 <g transform="matrix(1.04175,0,0,1.04175,-50.052284,-610.189202)">
                    ...
                    <foreignObject x="400" y="803" width="1900" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.name}</div>
                    </foreignObject>
                    ...
                    <foreignObject x="330" y="882" width="550" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.date}</div>
                    </foreignObject>
                    <foreignObject x="1130" y="882" width="600" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.id}</div>
                    </foreignObject>
                    <foreignObject x="1980" y="882" width="250" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.age}</div>
                    </foreignObject>
                    ...
                    <foreignObject x="340" y="973" width="500" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.dum}</div>
                    </foreignObject>
                    <foreignObject x="850" y="973" width="330" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.dpp}</div>
                    </foreignObject>
                    <foreignObject x="1410" y="973" width="800" height="120">
                        <input type="text" value={headerData.ig} onChange={e => handleHeaderChange('ig', e.target.value)} className="print:hidden w-full h-full bg-transparent text-[40px] ml-[17px] font-bold border-none outline-none uppercase appearance-none" />
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.ig}</div>
                    </foreignObject>
                    <foreignObject x="1920" y="973" width="300" height="120">
                        <input type="text" value={headerData.us} onChange={e => handleHeaderChange('us', e.target.value)} className="print:hidden w-full h-full bg-transparent text-[40px] ml-[18px] font-bold border-none outline-none uppercase appearance-none" />
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.us}</div>
                    </foreignObject>
                    ...
                    <foreignObject x="430" y="1056" width="500" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.parity}</div>
                    </foreignObject>
                    <foreignObject x="1120" y="1056" width="1100" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.bloodType}</div>
                    </foreignObject>
                    <foreignObject x="1700" y="1056" width="500" height="120">
                        ...
                        <div className="hidden print:flex w-full h-full items-center text-[40px] font-bold text-black uppercase leading-none">{headerData.babyName}</div>
                    </foreignObject>
                                    ...
                                    {row.rotate ? (
                                        ...
                                        <>
                                            <AutoResizingTextarea 
                                                value={col[row.key as keyof PartogramTableColumn] as string || ''}
                                                onChange={e => updateTableData(cIdx, row.key as keyof PartogramTableColumn, e.target.value.toUpperCase())}
                                                className={`print:hidden w-full h-full bg-transparent text-center ${(row as any).fontSize || 'text-[18px]'} font-bold border-none outline-none p-1 text-black uppercase resize-none overflow-hidden appearance-none leading-[0.8]`}
                                            />
                                            <div className={`hidden print:flex w-full h-full items-center justify-center bg-transparent text-center ${(row as any).fontSize || 'text-[32px]'} font-bold text-black uppercase overflow-hidden whitespace-pre-wrap leading-[0.8]`}>
                                                {col[row.key as keyof PartogramTableColumn] as string || ''}
                                            </div>
                                        </>
                                    )}
